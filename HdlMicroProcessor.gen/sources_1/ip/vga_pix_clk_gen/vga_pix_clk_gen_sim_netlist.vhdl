...
architecture STRUCTURE of vga_pix_clk_gen_clk_wiz is
...
entity vga_pix_clk_gen is
  ...
  attribute NotValidForBitStream of vga_pix_clk_gen : entity is true;
end vga_pix_clk_gen;

architecture STRUCTURE of vga_pix_clk_gen is
begin
