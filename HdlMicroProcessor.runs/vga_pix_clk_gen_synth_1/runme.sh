...
HD_PWD='/home/zww/Documents/College/2022SP/HDL/HdlMicroProcessor/HdlMicroProcessor.runs/vga_pix_clk_gen_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_pix_clk_gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_pix_clk_gen.tcl
