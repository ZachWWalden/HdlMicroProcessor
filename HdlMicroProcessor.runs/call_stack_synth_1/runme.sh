...
HD_PWD='/home/zww/Documents/College/2022SP/HDL/HdlMicroProcessor/HdlMicroProcessor.runs/call_stack_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log call_stack.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source call_stack.tcl
