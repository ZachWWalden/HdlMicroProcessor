...
create_clock -period 200.000 -name core_clk -waveform {0.000 100.000} -add [get_nets core_clk]
create_clock -period 20.000 -name mem_clk -waveform {0.000 10.000} -add [get_nets mem_clk]
create_clock -period 79.438 -name vga_clk -waveform {0.000 39.719} -add [get_nets vga_clk]
...
set_output_delay -clock [get_clocks vga_clk] -min -add_delay 0.000 [get_ports {blue[*]}]
set_output_delay -clock [get_clocks vga_clk] -max -add_delay 0.600 [get_ports {blue[*]}]
set_output_delay -clock [get_clocks vga_clk] -min -add_delay 0.000 [get_ports {green[*]}]
set_output_delay -clock [get_clocks vga_clk] -max -add_delay 0.600 [get_ports {green[*]}]
set_output_delay -clock [get_clocks vga_clk] -min -add_delay 0.000 [get_ports {red[*]}]
set_output_delay -clock [get_clocks vga_clk] -max -add_delay 0.600 [get_ports {red[*]}]
set_output_delay -clock [get_clocks vga_clk] -min -add_delay 0.000 [get_ports hsync]
set_output_delay -clock [get_clocks vga_clk] -max -add_delay 0.600 [get_ports hsync]
set_output_delay -clock [get_clocks vga_clk] -min -add_delay 0.000 [get_ports vsync]
set_output_delay -clock [get_clocks vga_clk] -max -add_delay 0.600 [get_ports vsync]
set_clock_groups -physically_exclusive -group [get_clocks -include_generated_clocks clk100M] -group [get_clocks -include_generated_clocks sys_clk_pin]
