...
#
# Generated by Vivado on Wed Apr 06 19:52:42 CDT 2022
...
# Script info
echo -e "clk_gen.sh - Script generated by export_simulation (Vivado v2021.1 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../HdlMicroProcessor.gen/sources_1/ip/vga_pix_clk_gen" +incdir+"$ref_dir/../../../../HdlMicroProcessor.gen/sources_1/ip/clk_gen" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../HdlMicroProcessor.gen/sources_1/ip/vga_pix_clk_gen" +incdir+"$ref_dir/../../../../HdlMicroProcessor.gen/sources_1/ip/clk_gen" \
    "$ref_dir/../../../../HdlMicroProcessor.gen/sources_1/ip/clk_gen/clk_gen_clk_wiz.v" \
    "$ref_dir/../../../../HdlMicroProcessor.gen/sources_1/ip/clk_gen/clk_gen.v" \
  2>&1 | tee -a vlogan.log
